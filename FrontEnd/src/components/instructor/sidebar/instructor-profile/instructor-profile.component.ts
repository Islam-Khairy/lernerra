...
export class InstructorProfileComponent {
  ...
  profileForm=this.fb.group({
    ...
    imageUrl=signal<string>(this.accountService.user()?.pictureUrl||"https://res.cloudinary.com/dnade0nhi/image/upload/v1754849990/DefaultImage_bixccf.jpg" )
  ...
  onSubmit() {
      ...
      const updateDto:updateUserDto={
        ...
        imageUrl:this.imageUrl()?  this.imageUrl()!:this.accountService.user()?.pictureUrl!
      }
